...
<main class="loader-screen" aria-busy={loading}>
  ...
  <section class="loader-copy">
    <p class="mono-label">SBM BOM / Component Cuts</p>
    <h1>Load model first. Then inspect material, mass, and layer logic.</h1>
    <p>
      Svelte5 starts from JSON ingestion. No WebGL work before input. Same BIM
      source, cinematic component-cut system.
    </p>
  </section>
  ...
  <aside class="loader-notes" aria-label="Visual direction">
    <span>cinematic blackbox palette</span>
